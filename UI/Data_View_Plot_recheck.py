...
from PyQt5.QtWidgets import QWidget, QPushButton, QApplication, QMainWindow, QGridLayout, QLabel, QToolBar, QDialog, \
    QMessageBox, QTableWidgetItem
from PyQt5.QtCore import Qt, QTimer, pyqtSlot, QThread, pyqtSignal
from PyQt5 import QtCore, QtWidgets
from PyQt5.QtGui import QPixmap, QImage
from PyQt5.QtWidgets import QAction, QStatusBar, QFileDialog, QGraphicsPixmapItem, QGraphicsView, QGraphicsScene
# import UI file
from UI.UI_DataViewPlot import Ui_Dialog
# import my own matplotlib InitialPlot
from Dependant.My_matplotlib import Myplot, InitialPlot, NavigationToolbar, MonitorPlot
...
from Class_Pandas_data_QTable import PandasInQTable

# import class to display pandas dataFrame data
from Dependant.Class_Pandas_data_QTable import PandasInQTable
from UI.PyQt_useful_tools import MyMsgBox
# import functions for first derivative
from UI.Calculate_derivative import cal_deriv,interp_derivative
    ...
    def on_Derivative_btn_clicked(self):
        ...
        if self.dict_data:
            ...
            if self.dict_data.get(X_axis):
                ...
                Y_list = self.dict_data.get(Y_axis)
                print(X_list, Y_list)
                derv_y,derv_x=cal_deriv(X_list,Y_list,X_axis,Y_axis)
                self.plot_scan_data(derv_x, derv_y, X_axis, '1s deriv')
                # another method
                derv_y, derv_x = interp_derivative(X_list, Y_list, 100, X_axis, Y_axis)
                self.plot_scan_data(derv_x, derv_y, X_axis, '1s deriv')
