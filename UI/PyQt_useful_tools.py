...
from PyQt5.QtCore import Qt, QTimer, pyqtSlot, QThread, pyqtSignal, QDate, QDateTime
from PyQt5 import QtCore, QtWidgets
from UI.UI_my_msg_box import Ui_Dialog
...
class MyMsgBox(QDialog, Ui_Dialog):
    close_sig = pyqtSignal(str)
    """
    show a message box contain info and detailed info
    :signal:choose to send signal <str> when msg_box close-event <YES> or canceled <Cancel>
